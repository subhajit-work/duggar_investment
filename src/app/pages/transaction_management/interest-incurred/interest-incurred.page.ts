...
/* tslint:disable */ 
@Component({
  selector: 'app-interest-incurred',
  templateUrl: './interest-incurred.page.html',
  styleUrls: ['./interest-incurred.page.scss'],
})
// End here


export class InterestIncurredPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'transactioninterest_headers';

        // table list data url name
        this.listing_url = 'transactioninterest';
        
        this.onHeaderData(this.headerUrlapi);
        
        // getlist data url name
        this.getlist('transactioninterest_getlist');
