...
/* tslint:disable */ 
@Component({
  selector: 'app-expiring-transaction',
  templateUrl: './expiring-transaction.page.html',
  styleUrls: ['./expiring-transaction.page.scss'],
})
// End here


export class ExpiringTransactionPage implements OnInit, OnDestroy {
