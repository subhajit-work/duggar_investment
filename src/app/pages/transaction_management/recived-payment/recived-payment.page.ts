...
/* tslint:disable */ 
@Component({
  selector: 'app-recived-payment',
  templateUrl: './recived-payment.page.html',
  styleUrls: ['./recived-payment.page.scss'],
})
// End here


export class RecivedPaymentPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'interest_headers';

        // table list data url name
        this.listing_url = 'interest';
        
        this.onHeaderData(this.headerUrlapi);
        
        // getlist data url name
        this.getlist('interest_getlist');
