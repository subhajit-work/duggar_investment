...
/* tslint:disable */ 
@Component({
  selector: 'app-reject-payment',
  templateUrl: './reject-payment.page.html',
  styleUrls: ['./reject-payment.page.scss'],
})
// End here


export class RejectPaymentPage implements OnInit, OnDestroy {
