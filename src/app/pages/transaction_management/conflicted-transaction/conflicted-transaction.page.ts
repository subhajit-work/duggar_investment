...
@Component({
  selector: 'app-conflicted-transaction',
  templateUrl: './conflicted-transaction.page.html',
  styleUrls: ['./conflicted-transaction.page.scss'],
})

export class ConflictedTransactionPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'transaction_conflicted_headers';
        ...
        this.api_parms = {
          page_url:'conflicted-transaction' 
        }
    ...
    // ..... tds Receive modal start ......
      async tdsReceiveOpenModal(_identifier, _item, _items) {
        const tds_modal = await this.modalController.create({
          component: AddCommonModelPage,
        ...
        return await tds_modal.present();
      }
    // tds Receive  modal end 
