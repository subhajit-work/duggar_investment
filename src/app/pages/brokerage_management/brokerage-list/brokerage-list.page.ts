...
import { CommonUtils } from '../../../services/common-utils/common-utils';
  ...
  @Component({
    ...
    templateUrl: './brokerage-list.page.html',
    styleUrls: ['./brokerage-list.page.scss'],
  })
  // End here
  
  
  export class BrokerageListPage implements OnInit, OnDestroy {
    ...
    constructor(
      ...
      // ------ init function call start -------
        commonFunction(){
          ...
          this.headerUrlapi = 'transactionbrokerage_headers';
      
          // table list data url name
          this.listing_url = 'transactionbrokerage';
  
  
          this.onHeaderData(this.headerUrlapi);
          
          // getlist data url name
          this.getlist('transactionbrokerage_getlist');
