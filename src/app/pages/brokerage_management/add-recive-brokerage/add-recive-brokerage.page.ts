...
/* tslint:disable */ 
@Component({
  selector: 'app-add-recive-brokerage',
  templateUrl: './add-recive-brokerage.page.html',
  styleUrls: ['./add-recive-brokerage.page.scss'],
})

export class AddReciveBrokeragePage implements OnInit, OnDestroy {
  constructor(
  ...
  // ------ init function call start -------
    commonFunction(){
      ...
      if( this.parms_action_name == 'edit'){
        ...
        this.form_api = 'brokerage/'+this.parms_action_id;

      }else if(this.parms_action_name == 'reject'){
        this.form_api = 'chequebounce/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'brokerage';
      ...
      (response:any) => {
        ...
        if(response.return_status > 0){
          ...
          if(this.clickButtonTypeCheck == 'Save'){
            ...
            this.router.navigate(['/recived-brokerage-list']);
