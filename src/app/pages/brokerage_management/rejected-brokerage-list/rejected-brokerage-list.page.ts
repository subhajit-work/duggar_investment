...
/* tslint:disable */ 
@Component({
  selector: 'app-rejected-brokerage-list',
  templateUrl: './rejected-brokerage-list.page.html',
  styleUrls: ['./rejected-brokerage-list.page.scss'],
})
// End here


export class RejectedBrokerageListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.api_parms = {
          pymnt_status:'3',
          page_url:'rejectedbrokerage-list'
        }
