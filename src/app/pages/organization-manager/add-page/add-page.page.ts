...
export class AddPagePage implements OnInit, OnDestroy {
  constructor(
...
//--------------  getlist data fetch start -------------
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      // getlist data
      // this.getlist('add_getlist');

      if( this.parms_action_name == 'edit'){
        // form submit api edit
        this.form_api = 'pages/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'pages'
      }
...
reloadPage(){
  if( this.parms_action_name == 'add'){
    ...
    this.model = {
      ...
      url: this.allEditData.return_data.url,
