...
@Component({
  ...
  templateUrl: './states-list.page.html',
  styleUrls: ['./states-list.page.scss'],
})
// End here


export class StatesListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'state_headers';
    
        // table list data url name
        this.listing_url = 'state';
