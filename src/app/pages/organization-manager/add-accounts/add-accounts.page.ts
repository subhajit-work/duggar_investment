...
export class AddAccountsPage implements OnInit, OnDestroy {
...
//--------------  getlist data fetch start -------------
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      // getlist data
      // this.getlist('notification_getlist');

      if( this.parms_action_name == 'edit'){
        // form submit api edit
        this.form_api = 'report/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'report'
      }
  ...
  init(){
    ...
    if( this.parms_action_name == 'edit'){
      ...
      this.submitIdentifire ='interestdate';
        ...
        (res:any) => {
          ...
          if(res.return_status > 0){
            this.model = {
              ...
              transaction_multiple_body : res.return_data.transaction_multiple_body,
              transaction_single_body : res.return_data.transaction_single_body,
              transaction_single_invoice : res.return_data.transaction_single_invoice
            };
  ...
  reloadPage(){
    if( this.parms_action_name == 'add'){
      ...
      this.model = {
        ...
        transaction_multiple_body : this.allEditData.return_data.transaction_multiple_body,
        transaction_single_body : this.allEditData.return_data.transaction_single_body,
        transaction_single_invoice : this.allEditData.return_data.transaction_single_invoice
      };
    }
  }
  // reload alert
