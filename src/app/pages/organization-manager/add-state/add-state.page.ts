...
export class AddStatePage implements OnInit, OnDestroy {
  constructor(
...
//--------------  getlist data fetch start -------------
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      // getlist data
      // this.getlist('state_getlist');

      if( this.parms_action_name == 'edit'){
        // form submit api edit
        this.form_api = 'state/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'state'
      }
        ...
        (res:any) => {
          ...
          if(res.return_status > 0){
            this.model = {
              ...
              gst_code: res.return_data.gst_code,
  ...
  reloadPage(){
    if( this.parms_action_name == 'add'){
      ...
      this.model = {
        ...
        gst_code: this.allEditData.return_data.gst_code,
