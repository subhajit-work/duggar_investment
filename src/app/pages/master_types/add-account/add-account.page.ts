...
//--------------  getlist data fetch start -------------
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      // getlist data
      // this.getlist('phone_getlist');

      if( this.parms_action_name == 'edit'){
        // form submit api edit
        this.form_api = 'accountbranch/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'accountbranch'
      }
        ...
        (res:any) => {
          ...
          if(res.return_status > 0){
            this.model = {
              ...
              gstin_no : res.return_data.gstin_no,
              ...
              bank : res.return_data.bank,
              branch : res.return_data.branch,
              banck_acc : res.return_data.banck_acc,
              ifsc : res.return_data.ifsc,
...
// ======================== form submit start ===================
  ...
  onSubmit(form:NgForm){
    ...
    if(this.fileVal) {
    // normal file upload
    fd.append("logo", this.fileVal, this.fileVal.name);
    }else{
      fd.append("logo", '');
    }
      ...
      (response:any) => {
        ...
        if(response.return_status > 0){
          ...
          if(this.clickButtonTypeCheck == 'Save'){
            ...
            this.router.navigate(['/accountbranch-list']);
...
normalFileUpload(event) {
  ...
  this.model.logo =  event.target.files[0].name;
}
fileCross(_item1){
  this.model.logo = '';
  this.model.profile2 = '';
  ...
  reloadPage(){
    if( this.parms_action_name == 'add'){
      ...
      this.model = {
        ...
        gstin_no : this.allEditData.return_data.gstin_no,
        short_code : this.allEditData.return_data.short_code,
        address : this.allEditData.return_data.address,
        ...
        bank : this.allEditData.return_data.bank,
        branch : this.allEditData.return_data.branch,
        banck_acc : this.allEditData.return_data.banck_acc,
        ifsc : this.allEditData.return_data.ifsc,
