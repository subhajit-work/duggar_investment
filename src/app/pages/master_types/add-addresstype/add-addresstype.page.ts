...
/* tslint:disable */ 
@Component({
  selector: 'app-add-addresstype',
  templateUrl: './add-addresstype.page.html',
  styleUrls: ['./add-addresstype.page.scss'],
})
 
export class AddAddresstypePage implements OnInit, OnDestroy {
  constructor(
...
//--------------  getlist data fetch start -------------
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      // getlist data
      // this.getlist('address_getlist');

      if( this.parms_action_name == 'edit'){
        // form submit api edit
        this.form_api = 'type/'+this.parms_action_id+'?identifier=address';
      }else{
        // form submit api add
        this.form_api = 'type?identifier=address'
      }
