...
@Component({
  ...
  templateUrl: './fiscal-year-list.page.html',
  styleUrls: ['./fiscal-year-list.page.scss'],
})
// End here


export class FiscalYearListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'fiscalyear_headers';

        // table list data url name
        this.listing_url = 'fiscalyear';
