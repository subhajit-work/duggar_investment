...
@Component({
  ...
  templateUrl: './tds-list.page.html',
  styleUrls: ['./tds-list.page.scss'],
})
// End here


export class TdsListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.onHeaderData('tds_headers');

        // table list data url name
        this.listing_url = 'tds';
