...
@Component({
  ...
  templateUrl: './addresstype-list.page.html',
  styleUrls: ['./addresstype-list.page.scss'],
})
// End here


export class AddresstypeListPage implements OnInit, OnDestroy {
