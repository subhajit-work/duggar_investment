  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      if( this.parms_action_name == 'edit'){
        ...
        this.form_api = 'notification/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'notification'
      }
        ...
        (res:any) => {
          ...
          if(res.return_status > 0){
            this.model = {
              ...
              display_text : res.return_data.display_text,
              email : res.return_data.email,
              is_transaction : res.return_data.is_transaction,
              notification : res.return_data.notification,
              sms : res.return_data.sms,
              subject : res.return_data.subject
            };
  ...
  reloadPage(){
    if( this.parms_action_name == 'add'){
      ...
      this.model = {
        ...
        display_text : this.allEditData.return_data.display_text,
        email : this.allEditData.return_data.email,
        is_transaction : this.allEditData.return_data.is_transaction,
        notification : this.allEditData.return_data.notification,
        sms : this.allEditData.return_data.sms,
        subject : this.allEditData.return_data.subject
      };
    }
  }
  // reload alert
