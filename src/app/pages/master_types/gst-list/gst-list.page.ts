...
@Component({
  ...
  templateUrl: './gst-list.page.html',
  styleUrls: ['./gst-list.page.scss'],
})
// End here


export class GstListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.onHeaderData('gst_headers');

        // table list data url name
        this.listing_url = 'gst';
