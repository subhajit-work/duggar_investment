...
/* tslint:disable */ 
@Component({
  selector: 'app-phonetype-list',
  templateUrl: './phonetype-list.page.html',
  styleUrls: ['./phonetype-list.page.scss'],
})
// End here


export class PhonetypeListPage implements OnInit, OnDestroy {
