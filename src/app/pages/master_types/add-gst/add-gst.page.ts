...
export class AddGstPage implements OnInit, OnDestroy {
  constructor(
...
//--------------  getlist data fetch start -------------
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      // getlist data
      this.getlist('gst_getlist');

      if( this.parms_action_name == 'edit'){
        // form submit api edit
        this.form_api = 'gst/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'gst'
      }
...
//----------- reload page start ------------
  reloadPage(){
    if( this.parms_action_name == 'add'){
      ...
      this.model = {
        gst : this.allEditData.return_data.gst,
