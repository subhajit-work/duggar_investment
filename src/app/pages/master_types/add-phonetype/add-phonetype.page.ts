...
/* tslint:disable */ 
@Component({
  selector: 'app-add-phonetype',
  templateUrl: './add-phonetype.page.html',
  styleUrls: ['./add-phonetype.page.scss'],
})
 
export class AddPhonetypePage implements OnInit, OnDestroy {
  constructor(
  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      if( this.parms_action_name == 'edit'){
        ...
        this.form_api = 'type/'+this.parms_action_id+'?identifier=phone';
      }else{
        // form submit api add
        this.form_api = 'type?identifier=phone'
      }
      ...
      (response:any) => {
        ...
        if(response.return_status > 0){
          ...
          if(this.clickButtonTypeCheck == 'Save'){
            ...
            this.router.navigate(['/phonetype-list']);
