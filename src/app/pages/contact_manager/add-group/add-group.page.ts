  ...
  // ------ init function call start ------
    ...
    commonFunction(){
      ...
      if( this.parms_action_name == 'edit'){
        ...
        this.form_api = 'group/'+this.parms_action_id;
      }else{
        // form submit api add
        this.form_api = 'group'
      }
      ...
      this.editDataSubscribe = this.http.get(this.form_api).subscribe(
        (res:any) => {
          ...
          if(res.return_status > 0){
            ...
            if(res.return_data.user_info && res.return_data.user_info.length > 0){
  ...
  reloadPage(){
    if( this.parms_action_name == 'add'){
      ...
      this.model = {
        ...
        is_login : this.allEditData.return_data.is_login,
        ...
        communication_email : this.allEditData.return_data.communication_email
      };

      if(this.allEditData.return_data.user_info){
      ...
      // console.log('country >', this.model.country);
      this.model.borrower = [];
      this.allEditData.return_data.client.forEach(element => {
        this.model.borrower.push(element.id);
      });
      // this.selectedPeople = [this.people[0].id, this.people[1].id]
    }
